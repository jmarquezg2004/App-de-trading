...
# Logo Arkez en base64 — incrustado directamente, no depende de archivos externos
...
LOGO_IMG  = '<img src="data:image/png;base64,' + LOGO_B64 + '" style="width:90px;height:auto;display:block;margin:0 auto">'
LOGO_SM   = '<img src="data:image/png;base64,' + LOGO_B64 + '" style="width:48px;height:auto;display:block;margin:0 auto">'
...
if not st.session_state.logged_in:
    st.markdown(f"""<div style="text-align:center;padding:40px 0 20px">
      <div style="margin-bottom:16px">{LOGO_IMG}</div>
      <div style="font:400 11px/1.5 IBM Plex Mono,mono;color:#8BA5C8;letter-spacing:2px;margin-top:4px">
